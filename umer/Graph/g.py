...
RMSE = pd.DataFrame({   'stacked_regression_RMSE':[42.7714],
			'RandomForestRegressor_RMSE':[44.1652],
			'KNeighborsRegressor_RMSE':[48.7101],
			'XGB_RMSE':[51.0294],
...
MAE = pd.DataFrame({ 'stacked_regression_MAE':[21.858],
			'RandomForestRegressor_MAE':[23.422],
			'KNeighborsRegressor_MAE':[25.95],
			'XGB_MAE':[27.777],
